...
public:
    ...
    void retranslateUi(QWidget *CameraControlsHelp)
    {
        ...
        label_11->setText(QApplication::translate("CameraControlsHelp", "G: Move render camera to preview camera", Q_NULLPTR));
        label_12->setText(QApplication::translate("CameraControlsHelp", "F: Move preview camera to render camera", Q_NULLPTR));
