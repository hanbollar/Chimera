...
QT_MOC_LITERAL(5, 52, 18), // "slot_loadSourceObj"
QT_MOC_LITERAL(6, 71, 18), // "slot_loadTargetObj"
...
void MyGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->slot_loadSourceObj(); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGL::sig_ResizeToCamera)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyGL::sig_DisableGUI)) {
                *result = 1;
                return;
            }
        }
